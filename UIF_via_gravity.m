...
g_m_probe1       = gravimeter(dtn_dtf_probe1,dr_correction_p1); % measured g from orbit
...
g_m_probe2       = gravimeter(dtn_dtf_probe2,dr_correction_p2);% measured g from orbit
